function myfun(){
	...
	var usersalary = userneed.options[userneed.selectedIndex].text;




	location.replace("https://www.google.com/search?q=" +"User Input: "+ UserInput +"  "+ "Brands :" +" "+ showITNow + " Location :" +" " + showITNow2 + " Salary : " + usersalary);
}
